...
/**
 * @oas [post] /admin/platform/creators/{id}/orders/{order_id}/complete
 * operationId: "AdminCompleteCreatorOrder"
 * summary: "Complete Creator Order"
 * description: "Marks an order as completed for a creator-owned order."
